    ...
    <>
        ...
        <div className="link">
          ...
          <div className="flex justify-center">
            <a
              ...
              href="\images\คำสั่งวิทยาลัย\2567\ตุลาคม\3\1.pdf"
              download="แต่งตั้งคณะกรรมการดำเนินงานตามโครงการเดินทางไกล อยู่ค่ายพักแรม และประดับแถบสามสี.pdf"
            >
              Download Link
            </a>
          </div>
      ...
      <div className="pt-8">
        <div>
          ...
          <iframe
            className="w-full aspect-video ... "
            src="/images/คำสั่งวิทยาลัย/2567/ตุลาคม/3/1.pdf"
          ></iframe>
        </div>
      </div>
    </>
