  ...
  return (
    <>
      <div>
        ...
        {/* ***************************** LInk And PDF ***************************** */}
        <div className="pt-4">
          <p className="text-sky-800 text-lg">เอกสาร PDF</p>
          <Link
            href="/images/ข่าวประชาสัมพันธ์/2568/กุมภาพันธ์/PDF/2.pdf"
          ...
          <iframe
            ...
            src="/images/ข่าวประชาสัมพันธ์/2568/กุมภาพันธ์/PDF/2.pdf"
          ></iframe>
        </div>
        {/* ***************************** LInk And PDF ***************************** */}
