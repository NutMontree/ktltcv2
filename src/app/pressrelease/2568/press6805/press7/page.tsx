          ...
          <div className='px-2'>
            ...
            <div className="pt-4">
              <p className="text-sky-800 text-lg">
                สามารถสเเกนได้ที่ QR Code หรือลิ้งค์
              </p>
              <Link
                href="
https://drive.google.com/drive/u/0/folders/1phgddFFt09qGJcdm9qwCmcfmm3zKMxge?fbclid=IwZXh0bgNhZW0CMTAAYnJpZBExQkFUMXV2cFVCVjBMZnBDSgEeyFMtSrH5yHqS8xLYwbbI8qjsAgBv4AnHMkMHpRKBvqNjT9CWS311-0FKItY_aem_Lt4sbvHexXa7bJngoRQ1MQ
// "
