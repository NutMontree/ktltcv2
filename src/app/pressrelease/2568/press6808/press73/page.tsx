      ...
      <section className="pt-20">
        <div className="">
          ...
          <div className='grid gap-4'>
            วันศุกร์ที่ 29 สิงหาคม 2568 วิทยาลัยเทคนิคกันทรลักษ์
            ภายใต้ โครงการ Fix it จิตอาสา อาชีวะร่วมด้วยช่วยประชาชน <br />
            นำโดย 👉นางสาวทักษิณา ชมจันทร์ ผู้อำนวยการวิทยาลัยเทคนิคกันทรลักษ์ พร้อมด้วย คณะผู้บริหาร ครู บุคลากรทางการศึกษา นักเรียน นักศึกษา ร่วมด้วยช่วยประชาชน ในการปรับปรุงบ้านเรือน เเละสภาพเเวดล้อมที่ได้รับผลกระทบจากเหตุการณ์ความไม่สงบในเขตชายเเดนไทย - กัมพูชา เมื่อวันที่ 24 กรกฎาคม 2568 ณ ต.เสาธงชัย อ.กันทรลักษ์ จ.ศรีสะเกษ <br />
            ขอขอบคุณเพลง : คนดีไม่มีวันตาย - ธีร์ ไชยเดช

            <Link href='https://www.youtube.com/watch?v=wY02J2HZ0kY&list=RDwY02J2HZ0kY&start_radio=1&fbclid=IwY2xjawMeXa5leHRuA2FlbQIxMABicmlkETFVamF4dlRxQ3FKbW5MN3dhAR6i62DxHdIZRQ_Q2eafWyuXnQDQEa4-EtSBPif3bVEeNvDtdTkHqUfSwGUJ4Q_aem_xtGZZuU00ffWgXVlusKCNA'>
              <p className="hover:text-sky-500">
                https://www.youtube.com/watch?v=wY02J2HZ0kY...
              </p>
            </Link>
